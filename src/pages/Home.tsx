    ...
    <>
      ...
      >
        <div className="flex flex-col text-center gap-8 md:gap-16">
          <h1
            className="text-4xl md:text-6xl font-extrabold pb-3"
            style={{ fontFamily: "IBM Plex Serif, serif" }}
          >
            Agency Flex Innovation
          </h1>
          <p
            className="text-lg md:text-2xl text-gray-300 px-5 pb-2"
            style={{ fontFamily: "IBM Plex Serif, serif" }}
          >
            " Transformamos tu negocio con webs flexibles, automatización
            inteligente y presencia digital de alto impacto "
          </p>
          <div className="py-12">
            <Button
