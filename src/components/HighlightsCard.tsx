...
const highlights: Highlight[] = [
  {
    title: "Diseño Web",
    description:
      "Concebimos y creamos webs o apps webs flexibles, adaptandonos a cada caso y a cada necesidad.",
    icon: <FaPalette size={36} className="text-blue-300" />,
  },
  {
    title: "Automatización",
    description:
      "Automatiza tu flujo de clientes con chatbots y agentes, ahorra tiempo y costes de personal.",
    icon: <FaRobot size={36} className="text-blue-300" />,
  },
  {
    title: "Digitalización",
    description:
      "Renueva tu imagen: web, contenido audiovisual, reseñas y presencia digital a medida para cada caso.",
  ...
  return (
    <section className="pt-20 md:pt-14 px-4 max-w-6xl md:max-w-full mx-auto flex flex-col md:flex-row justify-center items-center gap-12 md:gap-20">
      {highlights.map((item, index) => (
        <div
          key={index}
          className="w-full h-auto min-w-[200px] max-w-[500px] min-h-[200px] p-10 flex flex-col justify-between items-center
