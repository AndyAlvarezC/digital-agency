...
export default function ServicesCard() {
  return (
    <div
      className="w-full max-w-full md:w-[80%] rounded-3xl shadow-2xl bg-gradient-to-r from-blue-500 to-blue-800 
                    p-6 md:py-8 transform transition-all duration-300 hover:shadow-3xl"
    >
      {/* Encabezado */}
      <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6">
        ...
        <h2 className="text-xl md:text-4xl font-bold text-white text-center sm:text-left">
