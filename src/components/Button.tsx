  ...
  return (
    <div
      ...
      className={`bg-gradient-to-b from-[var(--blue1)] to-[var(--blue2)] hover:bg-gradient-to-b hover:from-blue-500 hover:to-blue-800 rounded-lg flex items-center justify-center text-center 
        px-4 py-2 transform transition-all duration-300 ease cursor-pointer hover:scale-105 shadow-md hover:shadow-[0_0_25px_rgba(0,173,255,0.8),0_0_50px_rgba(0,173,255,0.5)] ${
          className || ""
        }`}
    >
