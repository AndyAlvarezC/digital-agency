  ...
  <div className="fixed inset-0 z-0 w-full overflow-hidden">
    ...
    <div
      ...
      style={{
        ...
        `,
        backgroundSize:
          "200px 200px, 300px 300px, 250px 250px, 280px 280px, 220px 220px, 260px 260px, 290px 290px",
        backgroundPosition:
          "0 0, 40px 60px, 130px 270px, 70px 100px, 150px 50px, 220px 180px, 90px 220px",
      }}
    />
